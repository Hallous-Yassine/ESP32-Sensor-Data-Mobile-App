...
class HistoryTemperaturePage extends StatefulWidget {
  final String Pc_Ip_Address;

  HistoryTemperaturePage({required this.Pc_Ip_Address});

  @override
  _HistoryTemperaturePageState createState() => _HistoryTemperaturePageState();
}

class _HistoryTemperaturePageState extends State<HistoryTemperaturePage> {
  ...
  Future<void> fetchHistoryData() async {
    ...
    var url = "http://${widget.Pc_Ip_Address}/api/read_temperature.php?type=history_temperature";
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                      leading: Icon(
                        ...
                        color: Colors.blue[300], // Color of the icon
                        size: 30, // Size of the icon
                      ),
                      title: Text(
                        'Temperature: ${data['temperature'] ?? 'No temperature data'}',
                        style: TextStyle(
